# Resources — Apprentissage du français
...
### Journal en français facile (TV5Monde)
- **级别**: B1-B2
- **频率**: 每日更新
- **链接**: [TV5Monde](https://www.tv5monde.com/emissions/journal-en-francais-facile)
- **特点**: 慢速法语新闻，带词汇解释
...
| 网站 | 用途 | 链接格式 |
|------|------|----------|
| frdic.com | 法语发音+词典 | `https://www.frdic.com/dicts/fr/{word}` |
...
### 2026-05-09
- ✅ Voyages 01 完成
  - 词汇表: `vocabulary/voyages-01-vocab.md`
  - 语法: `grammar/prepositions-lieu.md`
  - 听力: `listening/voyages-01-listening.md`
